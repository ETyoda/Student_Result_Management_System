...
import Logo from "../../assets/logo.png";
import backgroundImage from "../../assets/student copy.png";
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div
        ...
        style={{ height: "80%", width: "60%", maxWidth: "1200px" }}
      >
        {/* Left side with image and slogan */}
        <div
        ...
        >
          <div className="text-center mb-8">
            <img src={Logo} alt="Logo" className="w-20 mx-auto" />
            <h2 className="text-2xl font-semibold" style={{ color: "#2C387E" }}>
              Welcome Back
            </h2>
          ...
          <div className="mb-4 relative">
            ...
            <label
              className={`absolute left-3 transition-all duration-200 text-gray-500 ${
                placeholderActive.email || emailOrId
                  ? "text-xs -top-2.5"
                  : "text-base top-3"
              }`}
            >
          ...
          <div className="mb-4 relative">
            ...
            <label
              className={`absolute left-3 transition-all duration-200 text-gray-500 ${
                placeholderActive.password || password
                  ? "text-xs -top-2.5"
                  : "text-base top-3"
              }`}
            >
          ...
          <div className="flex items-center mb-4">
            <input
              ...
              className="mr-2"
            />
            <label className="text-sm" style={{ color: "#2C387E" }}>
              Show password
            </label>
          </div>
