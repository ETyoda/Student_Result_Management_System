  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100 p-4">
      <div
        ...
        style={{ maxHeight: "90%", width: "60%", maxWidth: "1200px" }}
      >
        {/* Left side with image and slogan */}
        <div
          className="w-3/4 relative bg-cover"
        ...
        <div
          ...
          style={{ backgroundColor: "#E6F0F3", height: "100%" }}
        >
          <div className="text-center mb-8">
            <p className="text-lg" style={{ color: "#2C387E" }}>
              Parent Sign up
            </p>
          </div>
          ...
          <div className="mb-4 relative">
            ...
            <label
              className={`absolute left-3 transition-all duration-200 text-gray-500 ${
                placeholderActive.fullName || formData.fullName
                  ? "text-xs -top-2.5"
                  : "text-base top-3"
              }`}
            >
          ...
          <div className="mb-4 relative">
            ...
            <label
              className={`absolute left-3 transition-all duration-200 text-gray-500 ${
                placeholderActive.email || formData.email
                  ? "text-xs -top-2.5"
                  : "text-base top-3"
              }`}
            >
          ...
          <div className="mb-4 relative">
            ...
            <label
              className={`absolute left-3 transition-all duration-200 text-gray-500 ${
                placeholderActive.password || formData.password
                  ? "text-xs -top-2.5"
                  : "text-base top-3"
              }`}
            >
          ...
          <div className="mb-4 relative">
            ...
            <label
              className={`absolute left-3 transition-all duration-200 text-gray-500 ${
                placeholderActive.confirmPassword || formData.confirmPassword
                  ? "text-xs -top-2.5"
                  : "text-base top-3"
              }`}
            >
          ...
          <div className="mb-4 relative">
            <input
              ...
              onBlur={() =>
                handleBlur("studentFullName", formData.studentFullName)
              }
              className="w-full border border-gray-300 rounded-lg p-3 focus:border-blue-500 focus:outline-none"
              style={{ color: "#2C387E" }}
            />
            <label
              className={`absolute left-3 transition-all duration-200 text-gray-500 ${
                placeholderActive.studentFullName || formData.studentFullName
                  ? "text-xs -top-2.5"
                  : "text-base top-3"
              }`}
            >
          ...
          <div className="mb-4 relative">
            ...
            <label
              className={`absolute left-3 transition-all duration-200 text-gray-500 ${
                placeholderActive.studentId || formData.studentId
                  ? "text-xs -top-2.5"
                  : "text-base top-3"
              }`}
            >
